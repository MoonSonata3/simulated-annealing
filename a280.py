...
coordinates = []
with open(r"C:\Users\tombe\Documents\Master\Stochastic Simulation\Assignment 3\a280_filtered.txt", "r") as file:
    for line in file:
        line = line.strip()
...
opt_route = []
with open(r"C:\Users\tombe\Documents\Master\Stochastic Simulation\Assignment 3\a280_opt_filter.txt", "r") as file:
    for line in file:
